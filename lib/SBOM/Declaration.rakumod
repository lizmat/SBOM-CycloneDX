...
use SBOM::Claim:ver<0.0.2>:auth<zef:lizmat>;
use SBOM::Component:ver<0.0.2>:auth<zef:lizmat>;
use SBOM::Contact:ver<0.0.2>:auth<zef:lizmat>;
use SBOM::DataContents:ver<0.0.2>:auth<zef:lizmat>;
use SBOM::Governance:ver<0.0.2>:auth<zef:lizmat>;
use SBOM::Organization:ver<0.0.2>:auth<zef:lizmat>;
use SBOM::Graphics:ver<0.0.2>:auth<zef:lizmat>;
use SBOM::Reference:ver<0.0.2>:auth<zef:lizmat>;
use SBOM::RequirementGrouping:ver<0.0.2>:auth<zef:lizmat>;
...
class SBOM::EvidenceDataset:ver<0.0.2>:auth<zef:lizmat> does SBOM {
...
class SBOM::Signatory:ver<0.0.2>:auth<zef:lizmat> does SBOM {
...
#| of the organization.
class SBOM::Affirmation:ver<0.0.2>:auth<zef:lizmat> does SBOM {
...
class SBOM::Assessor:ver<0.0.2>:auth<zef:lizmat> does SBOM {
...
#| to claims.
class SBOM::Attestation:ver<0.0.2>:auth<zef:lizmat> does SBOM {
...
class SBOM::DeclarationEvidence:ver<0.0.2>:auth<zef:lizmat> does SBOM {
...
class SBOM::Target:ver<0.0.2>:auth<zef:lizmat> does SBOM {
