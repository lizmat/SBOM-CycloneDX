...
use SBOM::Considerations:ver<0.0.6>:auth<zef:lizmat>;
use SBOM::Graphics:ver<0.0.6>:auth<zef:lizmat>;
use SBOM::ModelParameters:ver<0.0.6>:auth<zef:lizmat>;
use SBOM::Property:ver<0.0.6>:auth<zef:lizmat>;

#- ConfidenceInterval ----------------------------------------------------------
#| The confidence interval of a metric.
class SBOM::ConfidenceInterval:ver<0.0.6>:auth<zef:lizmat> does SBOM {
...
class SBOM::PerformanceMetric:ver<0.0.6>:auth<zef:lizmat> does SBOM {
...
class SBOM::QuantitativeAnalysis:ver<0.0.6>:auth<zef:lizmat> does SBOM {
...
class SBOM::ModelCard:ver<0.0.6>:auth<zef:lizmat> does SBOM {
