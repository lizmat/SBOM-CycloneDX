...
class SBOM::ConfidenceInterval:ver<0.0.1>:auth<zef:lizmat> does SBOM {
...
class SBOM::PerformanceMetric:ver<0.0.1>:auth<zef:lizmat> does SBOM {
...
class SBOM::QuantitativeAnalysis:ver<0.0.1>:auth<zef:lizmat> does SBOM {
...
class SBOM::ModelCard:ver<0.0.1>:auth<zef:lizmat> does SBOM {
