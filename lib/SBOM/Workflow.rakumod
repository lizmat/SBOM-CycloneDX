...
use SBOM::ExecutionStep:ver<0.0.16>:auth<zef:lizmat>;
use SBOM::Property:ver<0.0.16>:auth<zef:lizmat>;
use SBOM::Reference:ver<0.0.16>:auth<zef:lizmat>;
use SBOM::RuntimeTopology:ver<0.0.16>:auth<zef:lizmat>;
use SBOM::Task:ver<0.0.16>:auth<zef:lizmat>;
use SBOM::Trigger:ver<0.0.16>:auth<zef:lizmat>;
use SBOM::Workspace:ver<0.0.16>:auth<zef:lizmat>;

#- Workflow --------------------------------------------------------------------
#| A specialized orchestration task.
class SBOM::Workflow:ver<0.0.16>:auth<zef:lizmat> does SBOM {
