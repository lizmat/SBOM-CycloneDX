...
use SBOM::Requirement:ver<0.0.13>:auth<zef:lizmat>;
use SBOM::Signature:ver<0.0.13>:auth<zef:lizmat>;

#- RequirementLevel ------------------------------------------------------------
#| The requirement level of a claim.
class SBOM::RequirementLevel:ver<0.0.13>:auth<zef:lizmat> does SBOM {
...
class SBOM::Standard:ver<0.0.13>:auth<zef:lizmat> does SBOM {
...
class SBOM::Definition:ver<0.0.13>:auth<zef:lizmat> does SBOM {
