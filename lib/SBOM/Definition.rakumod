...
class SBOM::RequirementLevel:ver<0.0.1>:auth<zef:lizmat> does SBOM {
...
class SBOM::Standard:ver<0.0.1>:auth<zef:lizmat> does SBOM {
...
class SBOM::Definition:ver<0.0.1>:auth<zef:lizmat> does SBOM {
