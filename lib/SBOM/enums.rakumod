...
my class AccessMode:ver<0.0.2>:auth<zef:lizmat> does Enumify { }
...
#| license.
my class Acknowledgement:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| The type of activity that is part of a machine learning model
#| development or operational lifecycle.
my class Activity:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| Specifies an aggregate type that describes how complete a
#| relationship is.
my class Aggregate:ver<0.0.2>:auth<zef:lizmat> does Enumify { }
...
my class Certification:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| The mode of operation in which a cryptographic algorithm (block
#| cipher) is used.
my class CertificationMode:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| The padding scheme that is used for a cryptographic algorithm.
my class CertificationPadding:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| Unit of CO2 cost.
my class CO2Cost:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| Specifies the type of a component.
my class ComponentType:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| The type for the related cryptographic material
my class Crypto:ver<0.0.2>:auth<zef:lizmat> does Enumify { }
...
my class CryptoAsset:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| A cryptographic function implemented by a cryptographic algorithm.
my class CryptoFunction:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| Public key type indicator.
my class CryptoKey:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| A concrete cryptographic protocol type.
my class CryptoProtocol:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| The key state as defined by NIST SP 800-57.
my class CryptoState:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#- D ---------------------------------------------------------------------------
#| Specifies information about the directional flow of data.
my class DataFlow:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| The general theme or subject matter of model data being specified.
my class DataSource:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#- E ---------------------------------------------------------------------------
#| EC curve name.
my class ECCurve:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| EdDSA curve name.
my class EdDSA:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| Specifies the optional encoding a text is represented in.
my class Encoding:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| The energy source of an energy provider.
my class Energy:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| Unit of energy.
my class EnergyUnit:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| A technique used in method of analysis.
my class Evidence:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| The target and execution environment in which an algorithm is
#| implemented in.
my class ExecutionEnvironment:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#- F ---------------------------------------------------------------------------
#| The identity field of the component which an evidence describes.
my class Field:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#- H ---------------------------------------------------------------------------
#| An algorithm to generate a hash value with.
my class HashAlgorithm:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#- J ---------------------------------------------------------------------------
#| The rationale of why the impact analysis state was asserted.
my class Justification:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#- L ---------------------------------------------------------------------------
#| Learning types describing the learning problem or hybrid
#| learning problem.
my class Learning:ver<0.0.2>:auth<zef:lizmat> does Enumify { }
...
my class LicenseId:ver<0.0.2>:auth<zef:lizmat> does Enumify { }
...
my class LicenseGranted:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

# fetched from https://raw.githubusercontent.com/spdx/license-list-data/refs/heads/main/json/licenses.json
#| A valid SPDX license name.
my class LicenseName:ver<0.0.2>:auth<zef:lizmat> does Enumify { }
...
my class Patch:ver<0.0.2>:auth<zef:lizmat> does Enumify { }
...
#| given lifecycle.
my class Phase:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| A platform for which an algorithm is implemented.
my class Platform:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#- R ---------------------------------------------------------------------------
#| Specifies the type of external reference.
my class ReferenceSource:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| The software versioning type of a release note.
my class ReleaseLevel:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| A type of issue resolvement.
my class ResolveType:ver<0.0.2>:auth<zef:lizmat> does Enumify { }
...
my class Response:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| Specifies the severity or risk scoring methodology or standard used.
my class RiskMethodology:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#- O ---------------------------------------------------------------------------
#| Describes the type of data output.
my class OutputType:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#- S ---------------------------------------------------------------------------
#| The scope of a component.
my class Scope:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#| Textual representation of a severity.
my class Severity:ver<0.0.2>:auth<zef:lizmat> does Enumify { }
...
#| "EdDSA".
my class SignatureAlgorithm:ver<0.0.2>:auth<zef:lizmat> does Enumify { }

#- T ---------------------------------------------------------------------------
#| Indicates the types of activities performed by the set of workflow tasks.
my class TaskActivity:ver<0.0.2>:auth<zef:lizmat> does Enumify { }
...
my class VulnerabilityState:ver<0.0.2>:auth<zef:lizmat> does Enumify { }
