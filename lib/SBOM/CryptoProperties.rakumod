...
use SBOM::AlgorithmProperties:ver<0.0.6>:auth<zef:lizmat>;
use SBOM::CryptoMaterialProperties:ver<0.0.6>:auth<zef:lizmat>;
use SBOM::CryptoProtocolProperties:ver<0.0.6>:auth<zef:lizmat>;

#- CertificateProperties -------------------------------------------------------
#| Properties for cryptographic assets of asset type 'certificate'
class SBOM::CertificateProperties:ver<0.0.6>:auth<zef:lizmat> does SBOM {
...
class SBOM::CryptoProperties:ver<0.0.6>:auth<zef:lizmat> does SBOM {
