...
class SBOM::Licensing:ver<0.0.11>:auth<zef:lizmat> does SBOM {
...
class SBOM::AnyLicense:ver<0.0.11>:auth<zef:lizmat> does SBOM {
...
class SBOM::License:ver<0.0.11>:auth<zef:lizmat>
...
#| text of the license.
class SBOM::LicenseInfo:ver<0.0.11>:auth<zef:lizmat> does SBOM {
...
#- SPDXLicense -----------------------------------------------------------------
class SBOM::SPDXLicense:ver<0.0.11>:auth<zef:lizmat>
  is SBOM::AnyLicense does SBOM {
