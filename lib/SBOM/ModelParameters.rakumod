...
#| solving.
class SBOM::Approach:ver<0.0.16>:auth<zef:lizmat> does SBOM {
...
class SBOM::ModelDataset:ver<0.0.16>:auth<zef:lizmat> does SBOM {
...
class SBOM::ModelFormat:ver<0.0.16>:auth<zef:lizmat> does SBOM {
...
class SBOM::ModelParameters:ver<0.0.16>:auth<zef:lizmat> does SBOM {
