...
class SBOM::CycloneDX::Phase:ver<0.0.1>:auth<zef:lizmat>
  does SBOM::NameDescription {
}

enum lifecylePhase (
  phaseDesign => SBOM::CycloneDX::Phase.new(
    "design",
  ...
  phasePre-build => SBOM::CycloneDX::Phase.new(
    "pre-build",
  ...
  phaseBuild => SBOM::CycloneDX::Phase.new(
    "build",
  ...
  phaseDecommision => SBOM::CycloneDX::Phase.new(
    "decommision",
