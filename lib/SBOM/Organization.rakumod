...
class SBOM::Address:ver<0.0.9>:auth<zef:lizmat> does SBOM {
...
#- Contact ---------------------------------------------------------------------
#| A person.
class SBOM::Contact:ver<0.0.9>:auth<zef:lizmat> does SBOM {
...
class SBOM::Organization:ver<0.0.9>:auth<zef:lizmat> does SBOM {
...
class SBOM::IndividualOrOrganization:ver<0.0.9>:auth<zef:lizmat> does SBOM {
...
class SBOM::Governor:ver<0.0.9>:auth<zef:lizmat> does SBOM {
