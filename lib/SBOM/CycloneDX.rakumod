...
use SBOM::Annotation:ver<0.0.14>:auth<zef:lizmat>;
use SBOM::Component:ver<0.0.14>:auth<zef:lizmat>;
use SBOM::Composition:ver<0.0.14>:auth<zef:lizmat>;
use SBOM::Declarations:ver<0.0.14>:auth<zef:lizmat>;
use SBOM::Definition:ver<0.0.14>:auth<zef:lizmat>;
use SBOM::Dependency:ver<0.0.14>:auth<zef:lizmat>;
use SBOM::Formulation:ver<0.0.14>:auth<zef:lizmat>;
use SBOM::Metadata:ver<0.0.14>:auth<zef:lizmat>;
...
use SBOM::Vulnerability:ver<0.0.14>:auth<zef:lizmat>;
...
class SBOM::CycloneDX:ver<0.0.14>:auth<zef:lizmat> does SBOM {
