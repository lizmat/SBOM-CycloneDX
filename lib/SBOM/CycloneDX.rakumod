...
use SBOM::Annotation:ver<0.0.5>:auth<zef:lizmat>;
use SBOM::Component:ver<0.0.5>:auth<zef:lizmat>;
use SBOM::Composition:ver<0.0.5>:auth<zef:lizmat>;
use SBOM::Declarations:ver<0.0.5>:auth<zef:lizmat>;
use SBOM::Definition:ver<0.0.5>:auth<zef:lizmat>;
use SBOM::Dependency:ver<0.0.5>:auth<zef:lizmat>;
use SBOM::Formulation:ver<0.0.5>:auth<zef:lizmat>;
use SBOM::Metadata:ver<0.0.5>:auth<zef:lizmat>;
...
use SBOM::Vulnerability:ver<0.0.5>:auth<zef:lizmat>;

#- CycloneDX -------------------------------------------------------------------
#| Providing the CycloneDX v1.6 JSON specification in Raku.
class SBOM::CycloneDX:ver<0.0.5>:auth<zef:lizmat> does SBOM {
