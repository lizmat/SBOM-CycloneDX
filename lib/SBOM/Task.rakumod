...
use SBOM::ExecutionStep:ver<0.0.10>:auth<zef:lizmat>;
use SBOM::Input:ver<0.0.10>:auth<zef:lizmat>;
use SBOM::Property:ver<0.0.10>:auth<zef:lizmat>;
use SBOM::Output:ver<0.0.10>:auth<zef:lizmat>;
use SBOM::Reference:ver<0.0.10>:auth<zef:lizmat>;
use SBOM::RuntimeTopology:ver<0.0.10>:auth<zef:lizmat>;
use SBOM::Trigger:ver<0.0.10>:auth<zef:lizmat>;
use SBOM::Workspace:ver<0.0.10>:auth<zef:lizmat>;

#- Task ------------------------------------------------------------------------
#| Describes the inputs, sequence of steps and resources used to
#| accomplish a task and its output.
class SBOM::Task:ver<0.0.10>:auth<zef:lizmat> does SBOM {
