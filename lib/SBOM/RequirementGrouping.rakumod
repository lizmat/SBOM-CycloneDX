...
use SBOM::Confidence:ver<0.0.11>:auth<zef:lizmat>;

#- Conformance -----------------------------------------------------------------
#| The conformance of the claim meeting a requirement.
class SBOM::Conformance:ver<0.0.11>:auth<zef:lizmat> does SBOM {
...
class SBOM::RequirementGrouping:ver<0.0.11>:auth<zef:lizmat> does SBOM {
