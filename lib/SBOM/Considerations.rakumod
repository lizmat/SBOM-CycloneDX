...
use SBOM::EnergyConsumption:ver<0.0.4>:auth<zef:lizmat>;
use SBOM::Property:ver<0.0.4>:auth<zef:lizmat>;

#- EthicalConsideration --------------------------------------------------------
#| What are the ethical risks involved in the application of a model?
class SBOM::EthicalConsideration:ver<0.0.4>:auth<zef:lizmat> does SBOM {
...
class SBOM::EnvironmentalConsiderations:ver<0.0.4>:auth<zef:lizmat> does SBOM {
...
#| affected groups?
class SBOM::FairnessAssessment:ver<0.0.4>:auth<zef:lizmat> does SBOM {
...
class SBOM::Considerations:ver<0.0.4>:auth<zef:lizmat> does SBOM {
