...
class SBOM::CO2Cost:ver<0.0.12>:auth<zef:lizmat> does SBOM {
...
class SBOM::EnergyCost:ver<0.0.12>:auth<zef:lizmat> does SBOM {
...
class SBOM::EnergyProvider:ver<0.0.12>:auth<zef:lizmat> does SBOM {
...
class SBOM::EnergyConsumption:ver<0.0.12>:auth<zef:lizmat> does SBOM {
...
class SBOM::EthicalConsideration:ver<0.0.12>:auth<zef:lizmat> does SBOM {
...
class SBOM::EnvironmentalConsiderations:ver<0.0.12>:auth<zef:lizmat> does SBOM {
...
#| affected groups?
class SBOM::FairnessAssessment:ver<0.0.12>:auth<zef:lizmat> does SBOM {
...
class SBOM::Considerations:ver<0.0.12>:auth<zef:lizmat> does SBOM {
