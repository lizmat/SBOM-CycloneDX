...
use SBOM::Claim:ver<0.0.7>:auth<zef:lizmat>;
...
use SBOM::RequirementGrouping:ver<0.0.7>:auth<zef:lizmat>;
...
class SBOM::EvidenceDataset:ver<0.0.7>:auth<zef:lizmat> does SBOM {
...
class SBOM::Signatory:ver<0.0.7>:auth<zef:lizmat> does SBOM {
...
#| of the organization.
class SBOM::Affirmation:ver<0.0.7>:auth<zef:lizmat> does SBOM {
...
class SBOM::Assessor:ver<0.0.7>:auth<zef:lizmat> does SBOM {
...
#| to claims.
class SBOM::Attestation:ver<0.0.7>:auth<zef:lizmat> does SBOM {
...
class SBOM::DeclarationEvidence:ver<0.0.7>:auth<zef:lizmat> does SBOM {
...
class SBOM::Target:ver<0.0.7>:auth<zef:lizmat> does SBOM {
...
#| claims, and evidence.
class SBOM::Declarations:ver<0.0.7>:auth<zef:lizmat> does SBOM {
