...
use SBOM::Tool:ver<0.0.6>:auth<zef:lizmat>;
...
#| given lifecycle.
class SBOM::Lifecycle:ver<0.0.6>:auth<zef:lizmat> does SBOM {
...
class SBOM::Metadata:ver<0.0.6>:auth<zef:lizmat> does SBOM {
