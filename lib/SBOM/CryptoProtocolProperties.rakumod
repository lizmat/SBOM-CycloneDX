...
class SBOM::CipherSuite:ver<0.0.12>:auth<zef:lizmat> does SBOM {
...
class SBOM::IKEv2TransformTypes:ver<0.0.12>:auth<zef:lizmat> does SBOM {
...
class SBOM::CryptoProtocolProperties:ver<0.0.12>:auth<zef:lizmat> does SBOM {
