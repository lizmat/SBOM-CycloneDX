...
use SBOM::CryptoProperties:ver<0.0.15>:auth<zef:lizmat>;
use SBOM::ComponentDataset:ver<0.0.15>:auth<zef:lizmat>;
use SBOM::ComponentEvidence:ver<0.0.15>:auth<zef:lizmat>;
use SBOM::HashedString:ver<0.0.15>:auth<zef:lizmat>;
use SBOM::License:ver<0.0.15>:auth<zef:lizmat>;
use SBOM::ModelCard:ver<0.0.15>:auth<zef:lizmat>;
use SBOM::Property:ver<0.0.15>:auth<zef:lizmat>;
use SBOM::Organization:ver<0.0.15>:auth<zef:lizmat>;
use SBOM::Reference:ver<0.0.15>:auth<zef:lizmat>;
use SBOM::ReleaseNotes:ver<0.0.15>:auth<zef:lizmat>;
use SBOM::Resolve:ver<0.0.15>:auth<zef:lizmat>;
use SBOM::Signature:ver<0.0.15>:auth<zef:lizmat>;

#- Development -----------------------------------------------------------------
#| An action during development, such as a commit.
class SBOM::Development:ver<0.0.15>:auth<zef:lizmat> does SBOM {
...
class SBOM::Commit:ver<0.0.15>:auth<zef:lizmat> does SBOM {
...
class SBOM::SWID:ver<0.0.15>:auth<zef:lizmat> does SBOM {
...
class SBOM::Component:ver<0.0.15>:auth<zef:lizmat> does SBOM {
...
class SBOM::Diff:ver<0.0.15>:auth<zef:lizmat> does SBOM {
...
class SBOM::Patch:ver<0.0.15>:auth<zef:lizmat> does SBOM {
...
#| may not be known.
class SBOM::Pedigree:ver<0.0.15>:auth<zef:lizmat> does SBOM {
