...
use SBOM::ModelCard:ver<0.0.3>:auth<zef:lizmat>;
...
use SBOM::Resolve:ver<0.0.3>:auth<zef:lizmat>;
...
class SBOM::Component:ver<0.0.3>:auth<zef:lizmat> does SBOM {
...
class SBOM::Diff:ver<0.0.3>:auth<zef:lizmat> does SBOM {
...
class SBOM::Patch:ver<0.0.3>:auth<zef:lizmat> does SBOM {
...
#| may not be known.
class SBOM::Pedigree:ver<0.0.3>:auth<zef:lizmat> does SBOM {
