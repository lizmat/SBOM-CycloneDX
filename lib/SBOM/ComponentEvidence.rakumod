...
use SBOM::Callstack:ver<0.0.3>:auth<zef:lizmat>;
...
class SBOM::Copyright:ver<0.0.3>:auth<zef:lizmat> does SBOM {
...
class SBOM::Occurrence:ver<0.0.3>:auth<zef:lizmat> does SBOM {
