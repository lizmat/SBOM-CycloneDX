...
use SBOM::Identity:ver<0.0.15>:auth<zef:lizmat>;
...
#| invocations.
class SBOM::Frame:ver<0.0.15>:auth<zef:lizmat> does SBOM {
...
class SBOM::Callstack:ver<0.0.15>:auth<zef:lizmat> does SBOM {
...
class SBOM::Copyright:ver<0.0.15>:auth<zef:lizmat> does SBOM {
...
class SBOM::Occurrence:ver<0.0.15>:auth<zef:lizmat> does SBOM {
...
class SBOM::ComponentEvidence:ver<0.0.15>:auth<zef:lizmat> does SBOM {
