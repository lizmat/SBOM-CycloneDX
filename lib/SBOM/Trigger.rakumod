...
class SBOM::Condition:ver<0.0.8>:auth<zef:lizmat> does SBOM {
...
class SBOM::Event:ver<0.0.8>:auth<zef:lizmat> does SBOM {
...
class SBOM::Trigger:ver<0.0.8>:auth<zef:lizmat> does SBOM {
