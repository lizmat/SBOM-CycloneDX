...
class SBOM::Condition:ver<0.0.11>:auth<zef:lizmat> does SBOM {
...
class SBOM::Event:ver<0.0.11>:auth<zef:lizmat> does SBOM {
...
class SBOM::Trigger:ver<0.0.11>:auth<zef:lizmat> does SBOM {
