...
use SBOM::Input:ver<0.0.9>:auth<zef:lizmat>;
use SBOM::Property:ver<0.0.9>:auth<zef:lizmat>;
use SBOM::Output:ver<0.0.9>:auth<zef:lizmat>;
use SBOM::Property:ver<0.0.9>:auth<zef:lizmat>;
use SBOM::Reference:ver<0.0.9>:auth<zef:lizmat>;

#- Condition -------------------------------------------------------------------
#| A condition that was used to determine a trigger should be activated.
class SBOM::Condition:ver<0.0.9>:auth<zef:lizmat> does SBOM {
...
class SBOM::Event:ver<0.0.9>:auth<zef:lizmat> does SBOM {
...
class SBOM::Trigger:ver<0.0.9>:auth<zef:lizmat> does SBOM {
